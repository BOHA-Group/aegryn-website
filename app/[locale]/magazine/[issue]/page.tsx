    ...
    <>
      ...
      <div className="relative">
        ...
        <section id="s-editorial" className="bg-magazine-white px-6 md:px-[120px] py-32">
          <p className="text-label-mag text-magazine-black/40 uppercase tracking-[0.15em] mb-12">Editorial</p>
          ...
          <div className="border-t border-magazine-black/10 pt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              ...
              <div className="space-y-5 text-body-mag text-magazine-black/65 leading-[1.8]">
                ...
                <p className="font-mono text-[9px] tracking-[0.12em] uppercase text-magazine-black/30">Aegryn Magazine - Saint-Sulpice, Switzerland - January 2027</p>
              </div>
            </div>

            <div className="mt-16 bg-magazine-ivory p-8">
              <p className="font-mono text-[8px] tracking-[0.18em] uppercase text-magazine-accent mb-3">Coming Next - April 2027</p>
