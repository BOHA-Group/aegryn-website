...
const PDF_API_URL      = '/api/magazine/report/2027/pdf'
const TOTAL_PAGES      = 18  // À mettre à jour après export Canva
const FIRST_PAGE_CHECK = path.resolve('public/reports/2027/pages/page.0001.jpg')
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates:  { canonical: `/${locale}/magazine/report/2027/pdf` },
  }
}

export default async function Report2027PdfPage({ params }: Props) {
  const { locale } = await params
