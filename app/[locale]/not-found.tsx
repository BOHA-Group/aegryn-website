...
export default function NotFound() {
  return (
    <section className="flex min-h-[60vh] flex-col items-center justify-center px-6 text-center">
      ...
      <Link
        href="/"
        className="inline-flex items-center gap-2 rounded-full bg-ag-apex px-6 py-3 font-sans text-sm font-bold text-ag-navy transition-all hover:bg-ag-black hover:text-white"
      >
        Retour à l&apos;accueil
      </Link>
    </section>
