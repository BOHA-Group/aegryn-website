...
function SitemapSection({ group }: { group: SitemapGroup }) {
  ...
  return (
    <div>
      <h2 className="font-mono text-[10px] uppercase tracking-[0.22em] text-ag-apex-ink mb-3">
        {t(group.labelKey)}
      </h2>
  ...
  return (
    <main className="bg-ag-off-white min-h-screen pt-32 pb-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-12">
          <p className="font-mono text-[10px] tracking-[0.28em] uppercase text-ag-apex-ink mb-4 flex items-center gap-2">
