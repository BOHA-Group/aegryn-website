...
export default function AdminDocumentsClient({ assetId, catalog, documents, dataRoomLightEnabled: initLightEnabled }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg bg-white border border-indigo-100 px-5 py-4 space-y-3">
        {/* Header */}
        <div className="flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              className="rounded-lg flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-widest bg-indigo-50 text-indigo-700 border border-indigo-200 px-3 py-1.5 hover:bg-indigo-100 transition-colors disabled:opacity-50"
            >
        ...
        return (
          <section key={dim} className="bg-white border border-gray-200">
            ...
            <button
              ...
              className="rounded-lg w-full flex items-center justify-between px-5 py-3.5 hover:bg-gray-50 transition-colors"
            >
                      ...
                      <div className="flex items-start justify-between gap-4 flex-wrap">
                        ...
                        <div className="flex items-start gap-3 min-w-0 flex-1">
                          ...
                          <div className="min-w-0">
                            ...
                            {entry.note_admin && (
                              <p className="rounded-lg text-[10px] text-ag-navy/70 mt-1 bg-ag-navy/5 px-2 py-1 border-l-2 border-ag-navy/20">
                                {entry.note_admin}
                              </p>
                            )}
                          </div>
                        ...
                        <div className="flex items-center gap-2 shrink-0 flex-wrap">
                          ...
                          {hasDoc && (
                            <button
                              ...
                              className="rounded-lg text-[10px] font-mono text-gray-400 hover:text-gray-700 border border-gray-200 px-2 py-1 hover:border-gray-400 transition-colors"
                            >
                      ...
                      {hasDoc && noteOpen[uploaded[0].id] && (
                        <div className="mt-3 pl-11">
                          <textarea
                            ...
                            className="rounded-lg w-full text-[12px] border border-gray-200 px-3 py-2 resize-none focus:outline-none focus:border-ag-navy/40 text-gray-700 bg-ag-navy/[0.02]"
                          />
                          <div className="flex gap-2 mt-1.5">
                            <button
                              ...
                              disabled={saving[uploaded[0].id]}
                              className="rounded-lg font-mono text-[9px] uppercase tracking-wider px-3 py-1.5 bg-ag-navy text-white hover:bg-ag-navy/90 transition-colors"
                            >
                              Enregistrer
                            </button>
                            <button
                              ...
                              className="rounded-lg font-mono text-[9px] uppercase tracking-wider px-3 py-1.5 border border-gray-200 text-gray-500 hover:border-gray-400 transition-colors"
                            >
                              Annuler
                            </button>
                          </div>
