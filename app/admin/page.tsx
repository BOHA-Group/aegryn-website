...
export default async function AdminIndexPage({
  ...
  const modules = [
    ...
    {
      href:    `/admin/kyc${tokenQs}`,
      title:   'KYC',
      desc:    'Validation des documents d\'identité, KYC et UBO',
      badge:   kycPending ?? 0,
      badgeLabel: 'en attente',
      color:   'border-orange-200 hover:border-orange-400',
    },
    {
      href:    `/admin/offers${tokenQs}`,
      title:   'Offres',
      desc:    'Offres soumises tous actifs confondus',
      badge:   offersSubmitted ?? 0,
      badgeLabel: 'à examiner',
      color:   'border-pink-200 hover:border-pink-400',
    },
    {
      href:    `/admin/transactions${tokenQs}`,
      title:   'Transactions',
      desc:    'Pipeline PTT — EI → AP → Séquestre → DD → Signing → Closing',
      badge:   transactionsOpen ?? 0,
      badgeLabel: 'en cours',
      color:   'border-indigo-200 hover:border-indigo-400',
    },
    {
      href:    `/admin/commissions${tokenQs}`,
      title:   'Commissions',
      desc:    'Co-signatures et apports d\'affaires partenaires',
      badge:   commissionsDue ?? 0,
      badgeLabel: 'dues',
      color:   'border-teal-200 hover:border-teal-400',
    },
    {
      href:    `/admin/partners${tokenQs}`,
      title:   'Partenaires',
      desc:    'Cabinets juridiques, expert-comptables, cybersécurité, apporteurs',
      badge:   null,
      badgeLabel: '',
      color:   'border-cyan-200 hover:border-cyan-400',
    },
    {
      href:    `/admin/analytics${tokenQs}`,
      title:   'Analytics',
      desc:    'KPIs opérationnels — vue d\'ensemble',
      badge:   null,
      badgeLabel: '',
      color:   'border-slate-200 hover:border-slate-400',
    },
    {
      href:    `/admin/settings${tokenQs}`,
      title:   'Paramètres',
      desc:    'Légal, templates emails, benchmark marché',
      badge:   null,
      badgeLabel: '',
      color:   'border-gray-200 hover:border-gray-400',
    },
