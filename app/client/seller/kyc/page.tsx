...
const REQUIRED_DOCS = [
  { type: 'id_card',                label: 'Pièce d\'identité du dirigeant', desc: 'Carte d\'identité ou passeport en cours de validité.' },
  ...
  { type: 'director_id',            label: 'Identité des dirigeants',        desc: 'Pièces d\'identité de tous les dirigeants si différents du cédant.' },
