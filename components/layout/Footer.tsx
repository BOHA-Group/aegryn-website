...
const assets = [
  { name: 'Subblink',       href: 'https://subblink.app',      label: 'B2B SaaS' },
...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-white/[0.06] bg-aegryn-obsidian">
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {/* Navigation */}
          <div>
            <p className="font-mono text-[10px] tracking-[0.2em] text-white/40 uppercase mb-4">Groupe</p>
            ...
            <ul className="space-y-3">
              {assets.map(({ name, href, label }) => (
                <li key={name}>
                  ...
                  >
                    {name}
                    <span className="font-mono text-[9px] text-white/30 group-hover:text-aegryn-apex transition-colors">
                      {label}
                    </span>
                  </a>
                </li>
          ...
          <div>
            ...
            <Link
              href="/advisory"
              className="inline-flex items-center gap-2 rounded-full border border-aegryn-apex/40 px-4 py-2 font-mono text-xs text-aegryn-apex hover:border-aegryn-apex hover:bg-aegryn-apex hover:text-aegryn-obsidian transition-all"
            >
              Découvrir
              <span>↗</span>
            </Link>
