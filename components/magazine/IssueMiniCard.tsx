    ...
    >
      ...
      >
        {issue.status === 'published' ? (
          /* ── Copie pixel-perfect du grand cover via transform scale ── */
          <div style={{ position: 'absolute', top: 0, left: 0, transformOrigin: 'top left', transform: 'scale(0.369)', width: 420, height: 595, overflow: 'hidden' }}>
            {/* BG photo */}
