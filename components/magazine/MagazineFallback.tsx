...
export function MagazineFallback({ pdfUrl }: MagazineFallbackProps) {
  return (
    <div className="flex flex-col items-center gap-6 bg-magazine-ivory min-h-screen py-16 px-4">
      ...
      <iframe
        ...
        className="w-full max-w-5xl border border-magazine-black/10"
        style={{ height: '85vh' }}
      />

      {/* Note développeur */}
      <p className="text-label-mag text-magazine-black/30 uppercase tracking-[0.1em] text-center max-w-prose">
        ...
        <code className="text-magazine-black/40">public/reports/aegryn-report-2026.pdf</code>.
      </p>
