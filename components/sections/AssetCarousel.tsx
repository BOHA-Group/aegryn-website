        ...
        {VISIBLE.map((asset) => {
          ...
          return (
            ...
            >
              ...
              />
              <div className="flex justify-between items-start mb-auto relative z-10">
                <span className="font-sans font-semibold text-[10px] tracking-[0.14em] uppercase text-ag-gray-light border border-ag-border px-2.5 py-1 rounded-md group-hover:border-ag-apex group-hover:text-ag-apex-ink transition-all duration-200">
