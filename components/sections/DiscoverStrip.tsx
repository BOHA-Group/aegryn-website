...
export function DiscoverStrip() {
  ...
  const articles = [
    { title: t('article1Title'), cat: t('article1Cat'), href: '/discover' },
    { title: t('article2Title'), cat: t('article2Cat'), href: '/discover' },
    { title: t('article3Title'), cat: t('article3Cat'), href: '/discover' },
  ]
