...
export const ISSUE_01: MagazineIssue = {
  ...
  sections: [
    ...
    { id: 's-editorial',   label: 'Editorial',          pillar: 'build', pageRange: 'p.08–12'  },
    { id: 's-market',      label: 'Tech & AI',          pillar: 'ai',    pageRange: 'p.17–29'  },
    { id: 's-ai',          label: 'Build',              pillar: 'build', pageRange: 'p.30–64'  },
    { id: 's-perspective', label: 'Money',              pillar: 'money', pageRange: 'p.65–81'  },
    { id: 's-transaction', label: 'Transaction',        pillar: 'money', pageRange: 'p.86–104' },
    { id: 's-buyers',      label: 'People',             pillar: 'build', pageRange: 'p.108–116'},
    { id: 's-outlook',     label: 'Life',               pillar: 'build', pageRange: 'p.118–129'},
    { id: 's-index',       label: 'AEGRYN Index',       pillar: 'build', pageRange: 'p.120–125'},
