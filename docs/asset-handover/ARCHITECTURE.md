...
_(Describe the overall architecture: monolithic / microservices / serverless / decoupled. Include a diagram if available.)_
...
```
/ (root)
├── _(describe main folders and their purpose)_
```
...
_(Describe current scaling approach, known bottlenecks, and recommended scaling path for the acquirer.)_

---

## 7. Tech Debt

_(List known tech debt items, their severity, and estimated remediation effort. If a register exists, reference it here.)_
