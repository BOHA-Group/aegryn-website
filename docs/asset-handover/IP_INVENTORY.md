...
## 5. Employee & Contractor IP Assignments

| Type | Coverage | Status | Document reference |
|---|---|---|---|
| Employees | _(All / Partial)_ | Signed / Pending | _(see I-04 in data room)_ |
| Contractors | _(All / Partial)_ | Signed / Pending | _(see I-04 in data room)_ |
...
_(Describe any proprietary data sets, trained models, or data licences that are part of the asset.)_
