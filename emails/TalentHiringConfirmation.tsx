...
export default function TalentHiringConfirmation({
  ...
  const texts = {
    fr: {
      ...
      p1: `Nous avons bien reçu votre mandat de recrutement pour le poste de ${roleTitle} chez ${company}.`,
    ...
    en: {
      ...
      p1: `We have received your recruitment mandate for the ${roleTitle} position at ${company}.`,
