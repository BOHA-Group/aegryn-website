...
export const routing = defineRouting({
  ...
  pathnames: {
    ...
    '/valoriser':                         '/valoriser',
    '/valoriser/lancement':               '/valoriser/lancement',
    '/valoriser/croissance':              '/valoriser/croissance',
    '/valoriser/restructuration':         '/valoriser/restructuration',
    '/valoriser/acquisition':             '/valoriser/acquisition',
    '/valoriser/transmission':            '/valoriser/transmission',
